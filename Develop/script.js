...
function generatePassword() {
  passwordLength = prompt("How many characters would you like your password? Choose between 8 and 128 characters.");
...
// Options
  if (!confirmLower && !confirmUpper && !confirmNumber && !confirmSpecial) {
    userChoices = alert("You must choose");
// All Options Chosen
...
// 3 Options Chosen
      ...
      console.log(userChoices);
  } else if (onfirmUpper && confirmNumber && confirmSpecial) {
